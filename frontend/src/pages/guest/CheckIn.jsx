...
const CheckIn = () => {
      ...
      <div className="animate-in fade-in zoom-in-95 duration-500 text-white max-w-3xl mx-auto">
        <div className="bg-dark-800 border border-dark-700 p-10 text-center rounded-xl shadow-2xl relative overflow-hidden">
          ...
          <div className="bg-dark-900 border border-dark-700 p-6 rounded-lg text-left max-w-md mx-auto space-y-3">
            <p className="text-xs text-gray-300 uppercase tracking-widest font-bold">Registration details</p>
            <div className="flex justify-between text-sm">
              <span className="text-gray-200">Arrival Time:</span>
              <span className="text-white font-bold">{arrivalTime}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-gray-200">ID Verification:</span>
  ...
  return (
    <div className="animate-in fade-in duration-500 pb-20 text-white">
      ...
      <p className="text-gray-200 mb-8">Fast-track your arrival by verifying your ID and accepting house policies online.</p>
      ...
      <div className="bg-dark-800 border border-dark-700 rounded-xl shadow-xl overflow-hidden max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-200 mb-4">Please upload a clear copy of a valid government-issued ID (Passport, Driver's License, or National Identity Card).</p>
            ...
            {idUploaded ? (
              <div className="border border-green-500/30 bg-green-500/5 p-6 rounded-lg text-center flex flex-col items-center justify-center">
                ...
                <p className="text-xs text-gray-200 mt-1">ID document successfully captured and registered.</p>
              ...
              <div onClick={handleIdUpload} className="border-2 border-dashed border-dark-700 bg-dark-900 hover:border-brand-500 p-8 text-center flex flex-col items-center justify-center cursor-pointer rounded-lg transition-all duration-300 group">
                ...
                <p className="text-xs text-gray-300">Supports PNG, JPG, or PDF up to 5MB</p>
              </div>
            )}
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-dark-900/40 p-5 rounded-lg border border-dark-700/60">
              <div>
                <label className="block text-xs uppercase font-bold tracking-wider text-gray-200 mb-2">Arrival Suite Date</label>
                <input type="text" value="Scheduled Date" disabled className="w-full bg-dark-900 border border-dark-700 text-gray-300 px-4 py-3 rounded cursor-not-allowed font-medium text-sm" />
              </div>
              <div>
                <label className="block text-xs uppercase font-bold tracking-wider text-gray-200 mb-2">Arrival Suite Time Window</label>
          ...
          <div>
            ...
            <p className="text-sm text-gray-200 mb-4">Please review and accept our Terms & Conditions of stay below to complete your contactless registration:</p>
            
            {/* Scrollable Terms & Conditions Box */}
            <div className="bg-dark-900 border border-dark-700 rounded-lg p-4 h-48 overflow-y-auto text-xs text-gray-200 space-y-3 mb-4 scrollbar-thin select-text">
            ...
            <label className="flex items-start gap-4 p-4 bg-dark-900 border border-dark-700 rounded-lg cursor-pointer hover:bg-dark-850 transition-colors">
              ...
              <div>
                ...
                <p className="text-xs text-gray-200 mt-1">I certify that all uploaded information is accurate and I formally accept all house policies and financial liabilities related to my stay.</p>
              </div>
            </label>
          </div>
          ...
          <button 
            ...
            className={`w-full py-4 text-base font-bold rounded-lg shadow-lg transition-all ${
              agreed && idUploaded && !isSubmitting
                ...
                : 'bg-dark-700 text-gray-300 cursor-not-allowed'
            }`}
          >
