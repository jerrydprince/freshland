    ...
    const htmlContent = `
      <html>
        ...
        <body>
          <div class="header">
            <div>
              <h1 class="brand-name">Freshland</h1>
          ...
          <div class="footer">
            <p>This is an official document generated by the Freshland PMS.</p>
            <p>© 2026 Freshland. All rights reserved.</p>
          </div>
        ...
        <div className="flex bg-dark-800 p-1.5 rounded-2xl border border-dark-700/60 shadow-lg select-none">
          {hasStoreKeepingAdmin && (
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 ${activeTab === 'inventory' ? 'bg-gradient-to-tr from-brand-600 to-brand-400 text-white shadow-lg' : 'text-gray-200 hover:text-white'}`}
            >
              <Layers size={14} />
          ...
          <button 
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 ${activeTab === 'request' ? 'bg-gradient-to-tr from-brand-600 to-brand-400 text-white shadow-lg' : 'text-gray-200 hover:text-white'}`}
          >
          ...
          {hasStoreKeepingAdmin && (
            <>
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 relative ${activeTab === 'approvals' ? 'bg-gradient-to-tr from-brand-600 to-brand-400 text-white shadow-lg' : 'text-gray-200 hover:text-white'}`}
              >
                <ShieldCheck size={14} />
              ...
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 relative ${activeTab === 'procurement' ? 'bg-gradient-to-tr from-brand-600 to-brand-400 text-white shadow-lg' : 'text-gray-200 hover:text-white'}`}
              >
                <ListOrdered size={14} />
              ...
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 ${activeTab === 'logs' ? 'bg-gradient-to-tr from-brand-600 to-brand-400 text-white shadow-lg' : 'text-gray-200 hover:text-white'}`}
              >
                <Clock size={14} />
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass-panel p-5 border border-dark-700/60 rounded-2xl relative overflow-hidden group">
              ...
              <p className="text-gray-300 text-xs font-bold uppercase tracking-wider">Total Valuation</p>
              <h3 className="text-2xl font-black text-white mt-2 flex items-center">
                <DollarSign size={20} className="text-brand-400" />
                ₦{totalValuation.toLocaleString()}
              </h3>
              <p className="text-[10px] text-gray-200 mt-1">Sum value of all active warehouse stock items.</p>
            </div>
            ...
            <div className="glass-panel p-5 border border-dark-700/60 rounded-2xl relative overflow-hidden group">
              ...
              <p className="text-gray-300 text-xs font-bold uppercase tracking-wider">Active Catalog Size</p>
              <h3 className="text-2xl font-black text-white mt-2">{items.length} Products</h3>
              <p className="text-[10px] text-gray-200 mt-1">Distinct items registered in inventory register.</p>
            </div>

            <div className="glass-panel p-5 border border-dark-700/60 rounded-2xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-24 h-24 bg-red-500/5 rounded-bl-full group-hover:bg-red-500/10 transition-colors" />
              <p className="text-gray-300 text-xs font-bold uppercase tracking-wider">Low Stock Warnings</p>
              <h3 className={`text-2xl font-black mt-2 ${lowStockCount > 0 ? 'text-red-400' : 'text-white'}`}>{lowStockCount} Items</h3>
              <p className="text-[10px] text-gray-200 mt-1">Registered products in store with quantity &lt; 10.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-dark-800 p-4 border border-dark-700/60 rounded-2xl shadow-md">
            <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto flex-1">
              <div className="relative flex-1 max-w-md">
                <Search className="absolute left-4 top-3 text-gray-300 w-4 h-4" />
                <input
                  type="text"
          ...
          <div className="glass-panel border border-dark-700/60 p-6 rounded-3xl shadow-xl overflow-x-auto">
            {loading ? (
              <div className="py-24 text-center">
                ...
                <p className="text-gray-300 text-xs">Syncing store keeping registry...</p>
              </div>
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-dark-900/60 border-b border-dark-700 text-gray-200 uppercase tracking-wider">
                  <tr>
                ...
                <tbody className="divide-y divide-dark-700">
                  {paginatedItems.map(item => (
                    <tr key={item.id} className="hover:bg-dark-700/20 transition-colors">
                      ...
                      <td className="p-4">
                        <span className="bg-dark-800 border border-dark-700/60 px-2.5 py-1 rounded-lg text-[9px] font-bold uppercase tracking-wider text-gray-200">
                          {CATEGORIES.find(c => c.value === item.category)?.label || item.category}
                        </span>
                      </td>
                      <td className="p-4 text-gray-200 max-w-xs truncate">{item.description}</td>
          ...
          <div className="lg:col-span-2 glass-panel border border-dark-700/60 p-6 rounded-3xl shadow-xl">
            ...
            <form onSubmit={handleOutgoingRequestSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Logged By (Giver)</label>
                  <div className="w-full bg-dark-900 border border-dark-700/80 rounded-xl p-3 text-gray-200 font-semibold flex items-center gap-2 select-none">
                ...
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Department of Receiver *</label>
                  <select
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Receiver Name (Full Name) *</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Select Inventory Item *</label>
                  <select
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Quantity to Release *</label>
                  <input
                    type="number"
                    required
                    min="1"
              ...
              <div>
                <label className="block text-gray-200 font-bold mb-1.5 uppercase">Reason / Notes (Optional)</label>
                <textarea
                  rows="3"
              ...
              <button
                ...
                className="w-full bg-gradient-to-tr from-brand-600 to-brand-400 hover:from-brand-500 hover:to-brand-300 disabled:from-dark-800 disabled:to-dark-800 disabled:text-gray-300 text-white font-bold py-3 px-4 rounded-xl mt-4 transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
              >
                {isProcessing ? (
              ...
              {items.map(i => (
                <div key={i.id} className="bg-dark-900/60 border border-dark-700/40 p-2.5 rounded-xl flex justify-between items-center text-[10px]">
                  <div className="min-w-0">
                    ...
                    <p className="text-gray-300 capitalize">{i.category}</p>
                  </div>
                      ...
                      {paginatedApprovals.map(log => {
                        ...
                        return (
                          <tr key={log.id} className="hover:bg-dark-700/20 transition-colors">
                            ...
                            <td className="p-4 text-gray-200 uppercase text-[9px] font-bold">
                              {log.department}
                            </td>
                            <td className="p-4">
                            ...
                            <td className="p-4 text-gray-300 max-w-xs truncate" title={log.notes}>{log.notes}</td>
                            <td className="p-4 text-right">
                              <div className="flex gap-2 justify-end">
                                <button 
                                  onClick={() => handleDeclineRelease(log)}
                                  className="bg-dark-850 hover:bg-red-500/10 text-gray-300 hover:text-red-400 p-2 rounded-lg border border-dark-700 transition-all font-bold"
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-panel p-5 border border-dark-700/60 rounded-2xl relative overflow-hidden group">
              ...
              <p className="text-gray-300 text-xs font-bold uppercase tracking-wider">Pending Procurements</p>
              <h3 className="text-2xl font-black text-white mt-2">
                {purchaseRequests.filter(r => r.status === 'pending_purchase').length} Requests
              </h3>
              <p className="text-[10px] text-gray-200 mt-1">Active purchase orders currently outstanding.</p>
            </div>
            ...
            <div className="glass-panel p-5 border border-dark-700/60 rounded-2xl relative overflow-hidden group">
              ...
              <p className="text-gray-300 text-xs font-bold uppercase tracking-wider">Estimated Outlay</p>
              ...
              <p className="text-[10px] text-gray-200 mt-1">Total estimated funds required for outstanding requests.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-dark-800 p-4 border border-dark-700/60 rounded-2xl shadow-md">
            <div>
              ...
              <p className="text-gray-200 text-xs">Create new purchase requests and manage stock receipt operations.</p>
            </div>
            <button 
                ...
                <tbody className="divide-y divide-dark-700">
                  {paginatedProcurements.map(req => (
                    <tr key={req.id} className="hover:bg-dark-700/20 transition-colors">
                      ...
                      <td className="p-4 text-gray-200 max-w-xs truncate" title={req.notes}>{req.notes || '-'}</td>
          ...
          <div className="flex flex-col xl:flex-row gap-4 items-center justify-between bg-dark-800 p-4 border border-dark-700/60 rounded-2xl shadow-md">
            <div className="flex flex-wrap items-center gap-3 w-full xl:w-auto">
              <div className="flex items-center gap-2 mr-1">
                ...
                <span className="text-xs text-gray-200 font-bold uppercase">Log Audits Filters</span>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-2 w-full xl:w-auto justify-end">
              ...
              <button 
                ...
                className="bg-dark-900 hover:bg-dark-700 border border-dark-700 text-gray-200 hover:text-white px-4 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5"
              >
                Refresh Log
              </button>
            </div>
                ...
                <tbody className="divide-y divide-dark-700">
                  {paginatedLogs.map(log => (
                    <tr key={log.id} className="hover:bg-dark-700/20 transition-colors">
                      ...
                      <td className="p-4 text-gray-200 font-bold uppercase text-[9px]">{log.department || 'N/A'}</td>
                      ...
                      <td className="p-4 text-gray-200 font-medium italic">{log.approved_by || 'System Auto'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in print:hidden">
          <div className="glass-panel max-w-md w-full border border-dark-700/80 p-6 rounded-3xl shadow-2xl relative">
            ...
            <form onSubmit={handleAddNewItemSubmit} className="space-y-4 text-xs">
              <div>
                <label className="block text-gray-200 font-bold mb-1.5 uppercase">Item Name *</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Price / Unit (NGN)</label>
                  <input
                    type="number"
                    required
                    min="0"
                ...
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Select Category</label>
                  <select
              ...
              <div>
                <label className="block text-gray-200 font-bold mb-1.5 uppercase">Starting Stock Quantity</label>
                <input
                  type="number"
                  required
                  min="0"
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in print:hidden">
          <div className="glass-panel max-w-md w-full border border-dark-700/80 p-6 rounded-3xl shadow-2xl relative">
            ...
            <form onSubmit={handleRestockSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Quantity to Add</label>
                  <input
                    type="number"
                    required
                    min="1"
                ...
                <div>
                  <label className="block text-gray-200 font-bold mb-1.5 uppercase">Unit Price (NGN)</label>
                  <input
                    type="number"
                    required
                    min="0"
              ...
              <div>
                <label className="block text-gray-200 font-bold mb-1.5 uppercase">Authorized Storekeeper (Giver)</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-gray-200 font-bold mb-1.5 uppercase">Notes (Optional)</label>
                <textarea
                  rows="2"
            ...
            <form onSubmit={handleCreatePurchaseRequest} className="space-y-6 text-xs">
                ...
                {newPurchaseItems.map((item, index) => (
                  <div key={index} className="bg-dark-900/60 border border-dark-700/40 p-4 rounded-2xl relative space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        <label className="block text-gray-200 font-bold mb-1.5 uppercase">Item Type</label>
                        <select
                      ...
                      {item.itemId ? (
                        <div>
                          <label className="block text-gray-200 font-bold mb-1.5 uppercase">Select Catalog Item *</label>
                          <select
                            required
                            value={item.itemId}
                            onChange={e => {
                        ...
                        <div>
                          <label className="block text-gray-200 font-bold mb-1.5 uppercase">Custom Item Name *</label>
                          <input
                            type="text"
                            required
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      <div>
                        <label className="block text-gray-200 font-bold mb-1.5 uppercase">Quantity Required *</label>
                        <input
                          type="number"
                          required
                          min="1"
                      ...
                      <div>
                        <span className="block text-gray-300 font-bold mb-1.5 uppercase">Total Price</span>
              ...
              <div className="flex justify-between items-center bg-dark-900/40 p-3 rounded-2xl border border-dark-700/60">
                ...
                <div className="text-right">
                  <span className="text-[10px] text-gray-300 font-bold uppercase tracking-wider block">Total Estimated Outlay</span>
              ...
              <div>
                <label className="block text-gray-200 font-bold mb-1.5 uppercase">Notes / Procurement Description</label>
                <textarea
                  rows="2"
